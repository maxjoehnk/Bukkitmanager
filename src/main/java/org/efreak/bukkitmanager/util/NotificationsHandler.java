...
public class NotificationsHandler {
    ...
    static {
        ...
        notificationsPlugin = (Notifications) PluginManager
                .getPlugin("Notifications");
    }
    ...
    public static void notify(String title, String line1, String line2) {
        if (config.getBoolean("Notifications.Enabled")) {
            if (notificationsPlugin != null) {
                ...
                if (title != null) {
                    if (line2 != null) notification = new Notification(title,
                            line1, line2);
                    else notification = new Notification(title, line1, "");
                } else {
                    if (line2 != null) notification = new Notification(line1,
                            line2);
