...
public class PlayerDisplaynameCmd extends Command {
    ...
    public PlayerDisplaynameCmd() {
        super("displayname", "Player.Displayname", "bm.player.displayname",
                Arrays.asList("(get|set|reset)", "[displayname]", "[player]"),
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length < 2) io
                .sendFewArgs(sender,
                        "/bm player displayname (get|set|reset) [displayname] [player]");
        else if (args.length > 4) io
                .sendManyArgs(sender,
                        "/bm player displayname (get|set|reset) [displayname] [player]");
        else {
            // get
            if (args[1].equalsIgnoreCase("get")) {
                if (args.length == 2 && sender instanceof Player) {
                    if (has(sender, "bm.player.displayname.get.your")) io
                            .send(sender,
                                    io.translate(
                                            "Command.Player.Displayname.Get.Your")
                                            .replaceAll(
                                                    "%displayname%",
                                                    new BmPlayer(
                    ...
                    if (has(sender, "bm.player.displayname.get.other")) {
                        ...
                        if (offPlayer != null) {
                            ...
                            io.send(sender,
                                    io.translate(
                                            "Command.Player.Displayname.Get.Other")
                                            .replaceAll("%player%",
                                                    player.getName())
                ...
                if (args.length == 3 && sender instanceof Player) {
                    if (has(sender, "bm.player.displayname.set.your")) {
                        ...
                        io.send(sender,
                                io.translate(
                                        "Command.Player.Displayname.Set.Your")
                                        .replaceAll("%displayname%",
                                                player.getDisplayName()));
                    }
                    ...
                    if (has(sender, "bm.player.displayname.set.other")) {
                        ...
                        if (offPlayer != null) {
                            ...
                            io.send(sender,
                                    io.translate(
                                            "Command.Player.Displayname.Set.Other")
                                            .replaceAll("%player%",
                                                    player.getName())
                                            .replaceAll("%displayname%",
                                                    args[2]));
                ...
                if (args.length == 2 && sender instanceof Player) {
                    if (has(sender, "bm.player.displayname.reset.your")) {
                        ...
                        io.send(sender,
                                io.translate(
                                        "Command.Player.Displayname.Reset.Your")
                                        .replaceAll("%displayname%",
                                                player.getDisplayName()));
                    }
                } else if (args.length == 3) {
                    if (has(sender, "bm.player.displayname.reset.other")) {
                        ...
                        if (offPlayer != null) {
                            ...
                            io.send(sender,
                                    io.translate(
                                            "Command.Player.Displayname.Reset.Other")
                                            .replaceAll("%player%",
                                                    player.getName())
                                            .replaceAll("%displayname%",
                                                    player.getDisplayName()));
