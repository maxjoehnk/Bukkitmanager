...
public abstract class Command {
    ...
    public Command(String arg1Label, String arg2HelpNode,
            String arg3HelpPermission, List<String> arg4Args,
            CommandCategory arg5Category) {
        ...
        tracker = EMetrics.createBasicTracker("Total Command Usage", category
                .toString().toLowerCase() + " " + label.toLowerCase());
    }

    public abstract boolean execute(CommandSender sender, String[] args);

    protected boolean has(CommandSender sender, String perm) {
        return Permissions.has(sender, perm, "/bm "
                + category.toString().toLowerCase() + " " + label);
    }
