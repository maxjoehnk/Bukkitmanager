...
public class EntityBlockFormHandler extends BlockHandler {
    ...
    public EntityBlockFormHandler(EntityBlockFormLogger arg1logger) {
        super(new File("Block" + File.separator + "EntityBlockForm.log"),
                arg1logger, LoggerConfiguration
                        .get("Block.EntityBlockForm.File"), LoggerConfiguration
                        .get("Block.EntityBlockForm.Database"));
    }
    ...
    public void logDb(HashMap<String, Object> values) {
        db.log("Log_EntityBlockFormEvent",
