...
public class BlockPistonRetractHandler extends BlockHandler {
    ...
    public BlockPistonRetractHandler(BlockPistonRetractLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockPistonRetract.log"),
                arg1logger, LoggerConfiguration
                        .get("Block.BlockPistonRetract.File"),
                LoggerConfiguration.get("Block.BlockPistonRetract.Database"));
    }
    ...
    public void logDb(HashMap<String, Object> values) {
        db.log("Log_BlockPistonRetractEvent",
