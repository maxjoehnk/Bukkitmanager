...
public class BlockPistonExtendHandler extends BlockHandler {
    ...
    public BlockPistonExtendHandler(BlockPistonExtendLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockPistonExtend.log"),
                arg1logger, LoggerConfiguration
                        .get("Block.BlockPistonExtend.File"),
                LoggerConfiguration.get("Block.BlockPistonExtend.Database"));
    }
    ...
    public void logDb(HashMap<String, Object> values) {
        db.log("Log_BlockPistonExtendEvent",
