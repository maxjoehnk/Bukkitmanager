...
public class BlockSpreadHandler extends BlockHandler {
    ...
    public BlockSpreadHandler(BlockSpreadLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockSpread.log"),
                arg1logger, LoggerConfiguration.get("Block.BlockSpread.File"),
                LoggerConfiguration.get("Block.BlockSpread.Database"));
    }
