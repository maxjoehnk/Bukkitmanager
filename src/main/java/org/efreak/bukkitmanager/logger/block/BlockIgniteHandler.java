...
public class BlockIgniteHandler extends BlockHandler {
    ...
    public BlockIgniteHandler(BlockIgniteLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockIgnite.log"),
                arg1logger, LoggerConfiguration.get("Block.BlockIgnite.File"),
                LoggerConfiguration.get("Block.BlockIgnite.Database"));
    }
