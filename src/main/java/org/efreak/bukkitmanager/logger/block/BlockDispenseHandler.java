...
public class BlockDispenseHandler extends BlockHandler {
    ...
    public BlockDispenseHandler(BlockDispenseLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockDispense.log"),
                arg1logger,
                LoggerConfiguration.get("Block.BlockDispense.File"),
                LoggerConfiguration.get("Block.BlockDispense.Database"));
    }
