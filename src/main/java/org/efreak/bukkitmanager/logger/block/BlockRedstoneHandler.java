...
public class BlockRedstoneHandler extends BlockHandler {
    ...
    public BlockRedstoneHandler(BlockRedstoneLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockRedstone.log"),
                arg1logger,
                LoggerConfiguration.get("Block.BlockRedstone.File"),
                LoggerConfiguration.get("Block.BlockRedstone.Database"));
    }
