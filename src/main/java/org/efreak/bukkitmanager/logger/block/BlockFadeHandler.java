...
public class BlockFadeHandler extends BlockHandler {
	...
	public BlockFadeHandler(BlockFadeLogger arg1logger) {
		super(new File("Block" + File.separator + "BlockFade.log"), arg1logger, LoggerConfiguration.get("Block.BlockFade.File"), LoggerConfiguration.get("Block.BlockFade.Database"));
	}
