...
public class BlockPlaceHandler extends BlockHandler {
    ...
    public BlockPlaceHandler(BlockPlaceLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockPlace.log"),
                arg1logger, LoggerConfiguration.get("Block.BlockPlace.File"),
                LoggerConfiguration.get("Block.BlockPlace.Database"));
    }
