...
public class BlockFromToHandler extends BlockHandler {
    ...
    public BlockFromToHandler(BlockFromToLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockFromTo.log"),
                arg1logger, LoggerConfiguration.get("Block.BlockFromTo.File"),
                LoggerConfiguration.get("Block.BlockFromTo.Database"));
    }
