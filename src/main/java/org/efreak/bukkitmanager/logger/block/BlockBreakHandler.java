...
public class BlockBreakHandler extends BlockHandler {
    ...
    public BlockBreakHandler(BlockBreakLogger arg1logger) {
        super(new File("Block" + File.separator + "BlockBreak.log"),
                arg1logger, LoggerConfiguration.get("Block.BlockBreak.File"),
                LoggerConfiguration.get("Block.BlockBreak.Database"));
    }
    ...
    public void logDb(HashMap<String, Object> values) {
        db.log("Log_BlockBreakEvent",
                "time, block, cancelled, player",
