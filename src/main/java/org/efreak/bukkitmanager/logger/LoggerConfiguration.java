...
public class LoggerConfiguration {
    ...
    public void initialize() {
        configFile = new File(Bukkitmanager.getInstance().getDataFolder(),
                "logger.yml");
    ...
    private void addContent(String eventType, String event) {
        if (configYaml.get(eventType + "." + event + ".Enabled") == null) configYaml
                .set(eventType + "." + event + ".Enabled", false);
        if (configYaml.get(eventType + "." + event + ".File") == null) configYaml
                .set(eventType + "." + event + ".File", false);
        if (configYaml.get(eventType + "." + event + ".Database") == null) configYaml
                .set(eventType + "." + event + ".Database", true);
    }
