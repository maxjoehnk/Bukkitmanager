...
public class PrepareItemEnchantHandler extends EnchantmentHandler {
    ...
    public PrepareItemEnchantHandler(PrepareItemEnchantLogger arg1logger) {
        super(new File("Enchantment" + File.separator
                + "PrepareItemEnchant.log"), arg1logger, LoggerConfiguration
                .get("Enchantment.PrepareItemEnchant.File"),
                LoggerConfiguration
                        .get("Enchantment.PrepareItemEnchant.Database"));
    }

    public String logFile(HashMap<String, Object> values) {
        String msg = io.translate("Logger.Enchantment.PrepareItemEnchant")
                .replaceAll("%eventname%", (String) values.get("EventName"));
        return msg;
    }

    @Override
    public void logDb(HashMap<String, Object> values) {
        db.log("Log_PrepareItemEnchantEvent",
                "time, enchantBlock, cancelled",
