...
public class EnchantItemHandler extends EnchantmentHandler {
    ...
    public EnchantItemHandler(EnchantItemLogger arg1logger) {
        super(new File("Enchantment" + File.separator + "EnchantItem.log"),
                arg1logger, LoggerConfiguration
                        .get("Enchantment.EnchantItem.File"),
                LoggerConfiguration.get("Enchantment.EnchantItem.Database"));
    }

    public String logFile(HashMap<String, Object> values) {
        String msg = io.translate("Logger.Enchantment.EnchantItem").replaceAll(
    ...
    public void logDb(HashMap<String, Object> values) {
        ...
        db.log("Log_EnchantItemEvent",
                "time, enchantBlock, cancelled, enchanter, enchantmentsToAdd, expLevelCost, inventory, item, view, viewers, button",
