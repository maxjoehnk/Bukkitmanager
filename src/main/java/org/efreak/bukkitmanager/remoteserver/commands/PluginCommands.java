    ...
    public String pluginList() {
        ...
        try {
            json.put(new JSONObject()
                    .put("updates", PluginManager.getPluginUpdateCount())
                    .put("plugins", PluginManager.getPlugins().length)
                    .toString());
        ...
        for (Plugin plugin : PluginManager.getPlugins()) {
            try {
                ...
                for (Permission permission : plugin.getDescription()
                        .getPermissions()) {
                ...
                String object = new JSONObject()
                        ...
                        .put("permissions", permissions).toString();
                json.put(object);
            } catch (JSONException e) {
                if (config.getDebug()) e.printStackTrace();
                return ReturnCodes.echo500();
