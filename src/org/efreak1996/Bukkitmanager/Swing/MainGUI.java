...
public class MainGUI {
	...
	private void initialize() {
		...
		frmBukkitmanagerGui.setIconImage(Toolkit.getDefaultToolkit().getImage(MainGUI.class.getResource("/img/swing/icon.png")));
		...
		createServer.setSelectedIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/Connect.png")));
		createServer.setIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/Connect.png")));
		...
		connectBukkit.setSelectedIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/createnewserver_big.png")));
		connectBukkit.setIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/createnewserver_big.png")));
		...
		loadServer.setSelectedIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/loadServer.png")));
		loadServer.setIcon(new ImageIcon(MainGUI.class.getResource("/img/swing/loadServer.png")));
