...
public class LeavesDecayHandler extends BlockHandler {
	...
	public LeavesDecayHandler(LeavesDecayLogger arg1logger) {
		super(new File("Block" + File.separator + "LeavesDecay.log"), arg1logger, LoggerConfiguration.get("Block.LeavesDecay.File"), LoggerConfiguration.get("Block.LeavesDecay.Database"));
	}
