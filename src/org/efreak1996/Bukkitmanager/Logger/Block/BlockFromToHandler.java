...
public class BlockFromToHandler extends BmBlockHandler {

	public BlockFromToHandler(BlockFromToLogger arg1logger) {
		super(new File("Block" + File.separator + "BlockFromTo.log"), arg1logger, BmLoggerConfiguration.get("Block.BlockFromTo.File"), BmLoggerConfiguration.get("Block.BlockFromTo.Database"));
	}
