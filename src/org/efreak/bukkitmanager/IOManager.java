...
public class IOManager {
	...
	public void sendConsoleAddon(BukkitmanagerAddon addon, String msg) {
		if (config.getBoolean("IO.Show-Prefix")) plugin.getServer().getConsoleSender().sendMessage(color(prefix + ChatColor.DARK_RED + "[" + addon.getAddonName() + "] " + ChatColor.WHITE + msg));
		else plugin.getServer().getConsoleSender().sendMessage(color(msg));		
	}
