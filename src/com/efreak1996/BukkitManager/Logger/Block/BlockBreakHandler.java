...
public class BlockBreakHandler extends BmBlockHandler {
	...
	public String logFile(HashMap<String, Object> values) {
		String msg = io.translate("Logger.Block.BlockBreak").replaceAll("%eventname%", (String) values.get("EventName")).replaceAll("%block_type%", ((Block) values.get("Block")).getType().toString())
