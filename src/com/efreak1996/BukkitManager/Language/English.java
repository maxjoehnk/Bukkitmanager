...
public class English extends Language {
	...
	public void updateLanguage() {
		...
		try {
			...
			set("Autobackup.Notification.Start", "Autobackup started!");
			set("Autobackup.Notification.Finish", "Autobackup finished!");
			...
			set("Autosave.Notification.Start", "Autosave started!");
			set("Autosave.Notification.Finish", "Autosave finished!");
			...
			set("Command.Automessage.Add", "A new Automessage was added at index %index%.");
			set("Command.Automessage.Remove", "The Automessage with Index %index% was removed.");
			set("Command.Automessage.Get", "The Automessage with Index %index% contains:");
			set("Command.Bukkit.Config.NotFound", "The entry %entry% was not found.");
			set("Command.Bukkit.Config.Get", "The entry %entry% has the value: &8%value%.");
			set("Command.Bukkit.Config.Set", "The entry %entry% was set to: &8%value%.");
			set("Command.Player.UnknownPlayer", "Unknown Player!");
			set("Command.Player.SpecifyPlayer", "Please specify a Player!");
			set("Command.Player.Cmd.Send", "Successfully send Command!");
			set("Command.Player.Cmd.Error", "Error sending Command!");
			...
			set("Command.Player.Exp.Error", "The Expvalue has to be an Integer!");
			...
			set("Command.Player.Health.Error", "The Healthvalue has to be an Integer!");
			set("Command.Player.Health.TooMuch", "This Helpvalue is to big! Choose a smaller one.");
			...
			set("Command.Player.Hide.Already.Your", "You are already hidden!");
			set("Command.Player.Hide.Already.Other", "%player% is already hidden!");
			set("Command.Player.Gamemode.Error", "Gamemode has to be a Integer!");
			set("Command.Player.Gamemode.Unknown", "Unknown Gamemode!");
			...
			set("Command.Player.Level.Error", "The Level has to be an Integer!");
			...
			set("Command.Player.Load", "%player%.dat loaded!");
			set("Command.Player.Save", "%player%.dat saved!");
			set("Command.Player.Show.Already.Your", "You are already visible!");
			set("Command.Player.Show.Already.Other", "%player% is already visible!");
			...
			set("Command.Plugin.Config.Get", "&aThe Entry %entry% has the value: &8%value%.");
			set("Command.Plugin.Config.Set", "&aThe Entry %entry% was set from: &8%value_old% &fto: &8%value_new%.");
			...
			set("Logger.Block.BlockBreak", "%eventname%;%block_type%;%block_pos_chunk_x%;%block_pos_chunk_z%;%block_pos_x%;%block_pos_y%;%block_pos_z%;%block_world%;%player_name%;%player_gamemode%;%player_iteminhand%");
			set("Logger.Block.BlockBurn", "%eventname%;%block_type%;%block_pos_chunk_x%;%block_pos_chunk_z%;%block_pos_x%;%block_pos_y%;%block_pos_z%;%block_world%");
